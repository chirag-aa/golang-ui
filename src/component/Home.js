    ...
    <>
        <div className='startUp-menue'>
          <div className='buttons'>
             <button type='button'  disabled={shouldSettingBeDisabled} className='button btn btn-primary' onClick={(e)=>handleSettingClick(e)} >Settings</button>
          ...
          <div className='buttons'>
             ...
             <button type='button' className='button btn btn-secondary'>Cancle</button>
          </div>
